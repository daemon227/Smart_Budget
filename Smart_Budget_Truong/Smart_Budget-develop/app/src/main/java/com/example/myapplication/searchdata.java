...
public class searchdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            mref = FirebaseDatabase.getInstance().getReference("IncomeData").child(user.getUid());
        }
    ...
    private void loadAutoCompleteDates() {
        mref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter adapter = new ArrayAdapter(searchdata.this,
    ...
    private void searchByFilter(Filter filter) {
        mref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // Gắn adapter đẹp
                SearchResultAdapter adapter = new SearchResultAdapter(searchdata.this, results);
                listdata.setAdapter(adapter);

                // Nếu rỗng → báo người dùng
                if (results.isEmpty()) {
                    Toast.makeText(searchdata.this, "Không có dữ liệu!", Toast.LENGTH_SHORT).show();
                }
            }
